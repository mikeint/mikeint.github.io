...
if(isset($_REQUEST['username'])){
	pg_prepare($dbconn, "passCheck", "SELECT name, password FROM login WHERE name=$1 AND password=$2");
	$sql=pg_execute($dbconn, "passCheck", array($_REQUEST['username'], $_REQUEST['password']));

	if($sql){ // Login
		$_SESSION['username'] = $_REQUEST['username'];
		header('Location: https://cs.utm.utoronto.ca/~sansonem/a1/game.html', true, 303);
		die();
	}else{
...
<script type="text/javascript" src="scripts.js"></script>
	...
	<form name="input" action=<?php echo '"' . $_SERVER['PHP_SELF'] . '"';?> method="post">
		<div id="content">
			...
			<div id="innercontent">
				<input type="text" name="username" value="Nickname" id="nameAndPw" onfocus="inputFocus(this)" onblur="inputBlur(this)" size="27"></input>
			    <input type="password" name="password" value="password" id="nameAndPw" onfocus="inputFocus(this)" onblur="inputBlur(this)" size="27"></input>
			...
			<form  action=<?php echo '"' . $_SERVER['PHP_SELF'] . '"';?> method="POST" >
				<table id="tableMustFade" style=<?php if(isset($_REQUEST['createName'])) echo "\"display:block\"";
					...
					<tr><td align="right" width="455"><img id="x" onclick="hideDiv()" src="img/x-button.png" alt="X"/> </td></tr><tr>
						<td><input id="nameAndPw" type="text" name="createName" value="Nickname"  onfocus="inputFocus(this)" onblur="inputBlur(this)" size="32"></td></tr><tr> 
						<td><input id="nameAndPw" type="text" name="createPassword" value="Password" onfocus="inputFocus(this)" onblur="inputBlur(this)" size="32"></td></tr><tr> 
...
<div style="position:absolute; right:0; bottom:0; color:#818384;"> Copyright © 2015 Sansone Inc. All rights reserved.</div>
